        ...
        <View style={{ marginBottom: scaleSize(40) }}>
          ...
          <View style={{ marginBottom: verticalScale(24) }}>
            ...
            >
              ...
              <Text style={{
                flex: 1,
                color: userData?.college ? colors.text : colors.textMuted,
                fontSize: 17,
                marginLeft: scaleSize(16),
                fontWeight: '500',
              }}>
                {userData?.college || 'Select your college'}
              </Text>
          ...
          <View style={{ marginBottom: verticalScale(24) }}>
            ...
            >
              ...
              <Text style={{
                flex: 1,
                color: userData?.branch ? colors.text : colors.textMuted,
                fontSize: 17,
                marginLeft: scaleSize(16),
                fontWeight: '500',
              }}>
                {userData?.branch || 'Select your branch'}
              </Text>
              <AntDesign name="down" size={16} color={colors.textMuted} />
            </TouchableOpacity>
          </View>
